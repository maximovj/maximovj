...
- 📚 Actualmente estoy aprendiendo **NestJS, Spring Boot, Python y Microservicios**
...
- 💬 Pregúntame sobre **BackEnd, FrontEnd, DevOps, Linux, Microservicios, Base de datos y más**
...
<table>
  <tr>
    <td align="center" width="200">
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" width="48" height="48" alt="MVC"/>
      <br><strong>MVC</strong>
      <br><small>Model-View-Controller</small>
    </td>
    <td align="center" width="200">
      <div style="background: #6C2BD9; padding: 8px; border-radius: 8px;">
        <span style="color: white; font-size: 24px;">⬡</span>
      </div>
      <br><strong>Hexagonal</strong>
      <br><small>Ports & Adapters</small>
    </td>
    <td align="center" width="200">
      <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/docker/docker-original.svg" width="48" height="48" alt="Microservicios"/>
      <br><strong>Microservicios</strong>
      <br><small>Arquitectura Distribuida</small>
    </td>
  </tr>
</table>
